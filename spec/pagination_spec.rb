...
RSpec.describe Pagination do
  ...
  describe '#call' do
    ...
    describe 'page param' do
      ...
      #1000000000000 **** buzz
#2.2.2 :025 > 1_000_000_000_000 / 179
# => 5586592178
# 2.2.2 :026 > 1_000_000_000_000 % 179
#  => 138
#  2.2.2 :027 > (5586592178 * 179) + 138
#   => 1000000000000
#   2.2.2 :028 > (1_000_000_000_000 / 179).ceil
#    => 5586592178
#    2.2.2 :029 > 1_000_000_000_000.divmod(179)
#     => [5586592178, 138]
#     2.2.2 :030 > 1_000_000_000_000.divmod(21)
#      => [47619047619, 1]
#      2.2.2 :031 > 1_000_000_000_000.divmod(1000)
#       => [1000000000, 0]
